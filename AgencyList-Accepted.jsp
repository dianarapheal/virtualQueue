        ...
        <form>
            <table border="1" align="center">
                ...
                <%
                    ...
                    String sel = "select * from tbl_agency a inner join tbl_place p on p.place_id=a.place_id inner join tbl_district d on d.district_id=p.district_id where a.agency_status=1";
